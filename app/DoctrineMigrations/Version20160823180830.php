 ...
 */
class Version20160823180830 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, room_id INT DEFAULT NULL, organiser_id INT DEFAULT NULL, start_time DATETIME NOT NULL, end_time DATETIME NOT NULL, extended_time DATETIME NOT NULL, purpose LONGTEXT NOT NULL, INDEX IDX_E00CEDDE54177093 (room_id), INDEX IDX_E00CEDDEA0631C12 (organiser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
